...
public class ElectronicsTest extends BaseTest {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        softAssert.assertEquals(actualQuantity, expectedQuantity, "Unable to verify quantity.");
        ...
        registerPage.enterPassword("jask1234");
        registerPage.enterConfirmPassword("jask1234");
        ...
        loginPage.enterPassword("jask1234");
        ...
        checkoutPage.enterPhoneNumber("1234567891");
        ...
        checkoutPage.enterCardNumber("5534567812345678");
       ...
       softAssert.assertEquals(actualUrl, expectedUrl, "Unable to verify URL.");
       softAssert.assertAll();
