...
public class ComputerTest extends BaseTest {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException{
        ...
        softAssert.assertEquals(desktopPage.verifyText(),"Build your own computer","Error in text");
        ...
        softAssert.assertEquals(homePage.verifyWelcomeStoreText(), expectedWelcomeText);
